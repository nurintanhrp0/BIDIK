...
public class Bidik extends Application {

    public static final String TAG = Bidik.class.getSimpleName();

    /*private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;*/
    private static Bidik mInstance;
    ...
    public static synchronized Bidik getInstance() {
        return mInstance;
    }
  ...
  public void setUrl() {
        this.url = "http://bidik.sesshomaru.xyz/api/";
    }
